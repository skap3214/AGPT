...
from v3.config import SmallConfig as Config
...
class AGPT(nn.Module):
    ...
    def __init__(
        ...
        self.transformer_blocks = nn.TransformerEncoder(encoder_layer=self.decoder_layer, num_layers=Config.NUM_BLOCKS)
