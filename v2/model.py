...
from modules import MistralMHA, MistralTransformer
...
multi_head_attention = MistralMHA(
    n_heads=Config.HEADS,
    n_kv_heads=Config.HEADS/2,
    dim=Config.N_EMBD,
    head_dim=Config.N_EMBD/Config.HEADS,
    sliding_window=Config.BLOCK_SIZE*2,
    max_batch_size=Config.BATCH_SIZE
)
class AGPT(MistralTransformer):
    def __init__(
        self, 
        vocab_size, 
        n_layers = Config.NUM_BLOCKS, 
        n_embd = Config.N_EMBD, 
        head_dim = int(Config.N_EMBD/Config.HEADS),
        mistral_mha: MistralMHA = multi_head_attention,
        sliding_window=int(Config.BLOCK_SIZE*2),
